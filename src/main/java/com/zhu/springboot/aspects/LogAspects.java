...
public class LogAspects {
    ...
    public void aopBefore(JoinPoint joinPoint) {
        ...
        log.info("{} - {}.{}({})", "before", joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), sb);
    }
    ...
    public void aopAfter(JoinPoint joinPoint) {
        ...
        log.info("{} - {}.{}({})", "after", joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), sb);
    }
